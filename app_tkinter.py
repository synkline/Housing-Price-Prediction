...
# PyInstaller path finding function
...
try:
    lr_model = joblib.load(get_model_path("models/linear_model.joblib"))
    rf_model = joblib.load(get_model_path("models/random_forest_model.joblib"))
    features = joblib.load(get_model_path("models/model_features.pkl"))
    location_encoder = joblib.load(get_model_path("models/location_encoder.joblib")) 
...
data_folder = get_model_path('archive')
